...
const Home = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-brand-bg" edges={["top"]}>
      ...
      >
        <View className="bg-brand-bg rounded-b-[28px] px-5 pt-5 pb-[13px]">
        ...
        <View className="px-5 pt-[18px] pb-5">
          ...
          >
            <View className="size-[26px] rounded-full bg-[#4A9EFF1A] items-center mr-4 justify-center">
              <View className="size-[7px] rounded-full bg-brand-blue" />
            </View>
          ...
          <View className="flex-row justify-between items-center mb-3">
            ...
            >
              <Text className="text-brand-text-secondary text-sm">See all</Text>
            </TouchableOpacity>
          </View>

          {
            isLoading ? <View className="items-center py-6">
